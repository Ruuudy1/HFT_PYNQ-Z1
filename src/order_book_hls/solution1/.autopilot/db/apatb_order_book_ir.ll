; ModuleID = 'C:/Users/ruuud/spring2025/cse145/AAAAHHHH/ECE1373_2016_hft_on_fpga/src/order_book_hls/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_order_book_ir(%"class.hls::stream<order, 0>"* noalias nocapture nonnull dereferenceable(12) %order_stream, %"class.hls::stream<ap_uint<64>, 0>"* noalias nocapture nonnull dereferenceable(8) %incoming_time, %"class.hls::stream<metadata, 0>"* noalias nocapture nonnull dereferenceable(16) %incoming_meta, %"class.hls::stream<order, 0>"* noalias nocapture nonnull dereferenceable(12) %top_bid, %"class.hls::stream<order, 0>"* noalias nocapture nonnull dereferenceable(12) %top_ask, %"class.hls::stream<ap_uint<64>, 0>"* noalias nocapture nonnull dereferenceable(8) %outgoing_time, %"class.hls::stream<metadata, 0>"* noalias nocapture nonnull dereferenceable(16) %outgoing_meta, %"struct.ap_uint<32>"* noalias nocapture nonnull dereferenceable(4) %top_bid_id, %"struct.ap_uint<32>"* noalias nocapture nonnull dereferenceable(4) %top_ask_id) local_unnamed_addr #1 {
entry:
  ...
  call fastcc void @copy_in(%"class.hls::stream<order, 0>"* nonnull %order_stream, %"class.hls::stream<order, 0>"* nonnull align 512 %order_stream_copy, %"class.hls::stream<ap_uint<64>, 0>"* nonnull %incoming_time, i64* nonnull align 512 %incoming_time_copy, %"class.hls::stream<metadata, 0>"* nonnull %incoming_meta, %"class.hls::stream<metadata, 0>"* nonnull align 512 %incoming_meta_copy, %"class.hls::stream<order, 0>"* nonnull %top_bid, %"class.hls::stream<order, 0>"* nonnull align 512 %top_bid_copy, %"class.hls::stream<order, 0>"* nonnull %top_ask, %"class.hls::stream<order, 0>"* nonnull align 512 %top_ask_copy, %"class.hls::stream<ap_uint<64>, 0>"* nonnull %outgoing_time, i64* nonnull align 512 %outgoing_time_copy, %"class.hls::stream<metadata, 0>"* nonnull %outgoing_meta, %"class.hls::stream<metadata, 0>"* nonnull align 512 %outgoing_meta_copy, %"struct.ap_uint<32>"* nonnull %top_bid_id, i32* nonnull align 512 %top_bid_id_copy, %"struct.ap_uint<32>"* nonnull %top_ask_id, i32* nonnull align 512 %top_ask_id_copy)
  call void @apatb_order_book_hw(%"class.hls::stream<order, 0>"* %order_stream_copy, i64* %incoming_time_copy, %"class.hls::stream<metadata, 0>"* %incoming_meta_copy, %"class.hls::stream<order, 0>"* %top_bid_copy, %"class.hls::stream<order, 0>"* %top_ask_copy, i64* %outgoing_time_copy, %"class.hls::stream<metadata, 0>"* %outgoing_meta_copy, i32* %top_bid_id_copy, i32* %top_ask_id_copy)
  call void @copy_back(%"class.hls::stream<order, 0>"* %order_stream, %"class.hls::stream<order, 0>"* %order_stream_copy, %"class.hls::stream<ap_uint<64>, 0>"* %incoming_time, i64* %incoming_time_copy, %"class.hls::stream<metadata, 0>"* %incoming_meta, %"class.hls::stream<metadata, 0>"* %incoming_meta_copy, %"class.hls::stream<order, 0>"* %top_bid, %"class.hls::stream<order, 0>"* %top_bid_copy, %"class.hls::stream<order, 0>"* %top_ask, %"class.hls::stream<order, 0>"* %top_ask_copy, %"class.hls::stream<ap_uint<64>, 0>"* %outgoing_time, i64* %outgoing_time_copy, %"class.hls::stream<metadata, 0>"* %outgoing_meta, %"class.hls::stream<metadata, 0>"* %outgoing_meta_copy, %"struct.ap_uint<32>"* %top_bid_id, i32* %top_bid_id_copy, %"struct.ap_uint<32>"* %top_ask_id, i32* %top_ask_id_copy)
  ret void
}

; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @copy_in(%"class.hls::stream<order, 0>"* noalias "unpacked"="0", %"class.hls::stream<order, 0>"* noalias align 512 "unpacked"="1", %"class.hls::stream<ap_uint<64>, 0>"* noalias "unpacked"="2", i64* noalias nocapture align 512 "unpacked"="3.0", %"class.hls::stream<metadata, 0>"* noalias "unpacked"="4", %"class.hls::stream<metadata, 0>"* noalias align 512 "unpacked"="5", %"class.hls::stream<order, 0>"* noalias "unpacked"="6", %"class.hls::stream<order, 0>"* noalias align 512 "unpacked"="7", %"class.hls::stream<order, 0>"* noalias "unpacked"="8", %"class.hls::stream<order, 0>"* noalias align 512 "unpacked"="9", %"class.hls::stream<ap_uint<64>, 0>"* noalias "unpacked"="10", i64* noalias nocapture align 512 "unpacked"="11.0", %"class.hls::stream<metadata, 0>"* noalias "unpacked"="12", %"class.hls::stream<metadata, 0>"* noalias align 512 "unpacked"="13", %"struct.ap_uint<32>"* noalias readonly "unpacked"="14", i32* noalias nocapture align 512 "unpacked"="15.0", %"struct.ap_uint<32>"* noalias readonly "unpacked"="16", i32* noalias nocapture align 512 "unpacked"="17.0") unnamed_addr #2 {
entry:
  ...
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<ap_uint<64>, 0>.54"(i64* align 512 %3, %"class.hls::stream<ap_uint<64>, 0>"* %2)
  ...
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<ap_uint<64>, 0>.54"(i64* align 512 %11, %"class.hls::stream<ap_uint<64>, 0>"* %10)
...
; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @copy_out(%"class.hls::stream<order, 0>"* noalias "unpacked"="0", %"class.hls::stream<order, 0>"* noalias align 512 "unpacked"="1", %"class.hls::stream<ap_uint<64>, 0>"* noalias "unpacked"="2", i64* noalias nocapture align 512 "unpacked"="3.0", %"class.hls::stream<metadata, 0>"* noalias "unpacked"="4", %"class.hls::stream<metadata, 0>"* noalias align 512 "unpacked"="5", %"class.hls::stream<order, 0>"* noalias "unpacked"="6", %"class.hls::stream<order, 0>"* noalias align 512 "unpacked"="7", %"class.hls::stream<order, 0>"* noalias "unpacked"="8", %"class.hls::stream<order, 0>"* noalias align 512 "unpacked"="9", %"class.hls::stream<ap_uint<64>, 0>"* noalias "unpacked"="10", i64* noalias nocapture align 512 "unpacked"="11.0", %"class.hls::stream<metadata, 0>"* noalias "unpacked"="12", %"class.hls::stream<metadata, 0>"* noalias align 512 "unpacked"="13", %"struct.ap_uint<32>"* noalias "unpacked"="14", i32* noalias nocapture readonly align 512 "unpacked"="15.0", %"struct.ap_uint<32>"* noalias "unpacked"="16", i32* noalias nocapture readonly align 512 "unpacked"="17.0") unnamed_addr #5 {
entry:
  ...
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<ap_uint<64>, 0>"(%"class.hls::stream<ap_uint<64>, 0>"* %2, i64* align 512 %3)
...
copy:                                             ; preds = %entry
  call fastcc void @"streamcpy_hls.p0class.hls::stream<ap_uint<64>, 0>.49"(%"class.hls::stream<ap_uint<64>, 0>"* nonnull %dst, i64* align 512 %src)
  br label %ret
...
; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @"streamcpy_hls.p0class.hls::stream<ap_uint<64>, 0>.49"(%"class.hls::stream<ap_uint<64>, 0>"* noalias nocapture "unpacked"="0", i64* noalias nocapture align 512 "unpacked"="1.0") unnamed_addr #4 {
entry:
  %2 = alloca i64
...
; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @"onebyonecpy_hls.p0class.hls::stream<ap_uint<64>, 0>.54"(i64* noalias nocapture align 512 "unpacked"="0.0" %dst, %"class.hls::stream<ap_uint<64>, 0>"* noalias "unpacked"="1" %src) unnamed_addr #3 {
entry:
  %0 = icmp eq %"class.hls::stream<ap_uint<64>, 0>"* %src, null
  br i1 %0, label %ret, label %copy

copy:                                             ; preds = %entry
  call fastcc void @"streamcpy_hls.p0class.hls::stream<ap_uint<64>, 0>.57"(i64* align 512 %dst, %"class.hls::stream<ap_uint<64>, 0>"* nonnull %src)
  br label %ret
...
; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @"streamcpy_hls.p0class.hls::stream<ap_uint<64>, 0>.57"(i64* noalias nocapture align 512 "unpacked"="0.0", %"class.hls::stream<ap_uint<64>, 0>"* noalias nocapture "unpacked"="1") unnamed_addr #4 {
entry:
...
declare void @apatb_order_book_hw(%"class.hls::stream<order, 0>"*, i64*, %"class.hls::stream<metadata, 0>"*, %"class.hls::stream<order, 0>"*, %"class.hls::stream<order, 0>"*, i64*, %"class.hls::stream<metadata, 0>"*, i32*, i32*)

; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @copy_back(%"class.hls::stream<order, 0>"* noalias "unpacked"="0", %"class.hls::stream<order, 0>"* noalias align 512 "unpacked"="1", %"class.hls::stream<ap_uint<64>, 0>"* noalias "unpacked"="2", i64* noalias nocapture align 512 "unpacked"="3.0", %"class.hls::stream<metadata, 0>"* noalias "unpacked"="4", %"class.hls::stream<metadata, 0>"* noalias align 512 "unpacked"="5", %"class.hls::stream<order, 0>"* noalias "unpacked"="6", %"class.hls::stream<order, 0>"* noalias align 512 "unpacked"="7", %"class.hls::stream<order, 0>"* noalias "unpacked"="8", %"class.hls::stream<order, 0>"* noalias align 512 "unpacked"="9", %"class.hls::stream<ap_uint<64>, 0>"* noalias "unpacked"="10", i64* noalias nocapture align 512 "unpacked"="11.0", %"class.hls::stream<metadata, 0>"* noalias "unpacked"="12", %"class.hls::stream<metadata, 0>"* noalias align 512 "unpacked"="13", %"struct.ap_uint<32>"* noalias "unpacked"="14", i32* noalias nocapture readonly align 512 "unpacked"="15.0", %"struct.ap_uint<32>"* noalias "unpacked"="16", i32* noalias nocapture readonly align 512 "unpacked"="17.0") unnamed_addr #5 {
entry:
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<order, 0>"(%"class.hls::stream<order, 0>"* %0, %"class.hls::stream<order, 0>"* align 512 %1)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<ap_uint<64>, 0>"(%"class.hls::stream<ap_uint<64>, 0>"* %2, i64* align 512 %3)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<metadata, 0>"(%"class.hls::stream<metadata, 0>"* %4, %"class.hls::stream<metadata, 0>"* align 512 %5)
...
declare void @order_book_hw_stub(%"class.hls::stream<order, 0>"* noalias nocapture nonnull, %"class.hls::stream<ap_uint<64>, 0>"* noalias nocapture nonnull, %"class.hls::stream<metadata, 0>"* noalias nocapture nonnull, %"class.hls::stream<order, 0>"* noalias nocapture nonnull, %"class.hls::stream<order, 0>"* noalias nocapture nonnull, %"class.hls::stream<ap_uint<64>, 0>"* noalias nocapture nonnull, %"class.hls::stream<metadata, 0>"* noalias nocapture nonnull, %"struct.ap_uint<32>"* noalias nocapture nonnull, %"struct.ap_uint<32>"* noalias nocapture nonnull)

define void @order_book_hw_stub_wrapper(%"class.hls::stream<order, 0>"*, i64*, %"class.hls::stream<metadata, 0>"*, %"class.hls::stream<order, 0>"*, %"class.hls::stream<order, 0>"*, i64*, %"class.hls::stream<metadata, 0>"*, i32*, i32*) #7 {
entry:
  %9 = call i8* @malloc(i64 8)
  %10 = bitcast i8* %9 to %"class.hls::stream<ap_uint<64>, 0>"*
  %11 = call i8* @malloc(i64 8)
  %12 = bitcast i8* %11 to %"class.hls::stream<ap_uint<64>, 0>"*
  %13 = call i8* @malloc(i64 4)
  %14 = bitcast i8* %13 to %"struct.ap_uint<32>"*
  %15 = call i8* @malloc(i64 4)
  %16 = bitcast i8* %15 to %"struct.ap_uint<32>"*
  call void @copy_out(%"class.hls::stream<order, 0>"* null, %"class.hls::stream<order, 0>"* %0, %"class.hls::stream<ap_uint<64>, 0>"* %10, i64* %1, %"class.hls::stream<metadata, 0>"* null, %"class.hls::stream<metadata, 0>"* %2, %"class.hls::stream<order, 0>"* null, %"class.hls::stream<order, 0>"* %3, %"class.hls::stream<order, 0>"* null, %"class.hls::stream<order, 0>"* %4, %"class.hls::stream<ap_uint<64>, 0>"* %12, i64* %5, %"class.hls::stream<metadata, 0>"* null, %"class.hls::stream<metadata, 0>"* %6, %"struct.ap_uint<32>"* %14, i32* %7, %"struct.ap_uint<32>"* %16, i32* %8)
  call void @order_book_hw_stub(%"class.hls::stream<order, 0>"* %0, %"class.hls::stream<ap_uint<64>, 0>"* %10, %"class.hls::stream<metadata, 0>"* %2, %"class.hls::stream<order, 0>"* %3, %"class.hls::stream<order, 0>"* %4, %"class.hls::stream<ap_uint<64>, 0>"* %12, %"class.hls::stream<metadata, 0>"* %6, %"struct.ap_uint<32>"* %14, %"struct.ap_uint<32>"* %16)
  call void @copy_in(%"class.hls::stream<order, 0>"* null, %"class.hls::stream<order, 0>"* %0, %"class.hls::stream<ap_uint<64>, 0>"* %10, i64* %1, %"class.hls::stream<metadata, 0>"* null, %"class.hls::stream<metadata, 0>"* %2, %"class.hls::stream<order, 0>"* null, %"class.hls::stream<order, 0>"* %3, %"class.hls::stream<order, 0>"* null, %"class.hls::stream<order, 0>"* %4, %"class.hls::stream<ap_uint<64>, 0>"* %12, i64* %5, %"class.hls::stream<metadata, 0>"* null, %"class.hls::stream<metadata, 0>"* %6, %"struct.ap_uint<32>"* %14, i32* %7, %"struct.ap_uint<32>"* %16, i32* %8)
  call void @free(i8* %9)
